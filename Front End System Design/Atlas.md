Atlassian really values practical implementation details, especially around performance and scalability. they expect candidates to go beyond just the basics (which it sounds like u did last time) and dive deeper.
