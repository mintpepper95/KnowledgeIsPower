...
So re-render doesn't mean DOM nodes will update. If reconciliation determines there are no changes for a component in the virtual DOM, then React won't update the corresponding DOM nodes.
```ts
